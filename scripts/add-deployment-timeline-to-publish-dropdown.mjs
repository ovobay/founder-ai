...
/**
 * Adds a compact deployment timeline to PublishDropdownPopover.
 *
 * The timeline shows:
 * - Draft
 * - Preview
 ...
 * - Published
 *
 * The current step is highlighted based on:
 * - file existence
 * - publish gate decision
 * - local published snapshot state
 *
 * This makes the dropdown feel like a real deployment control instead of a form
 * holding a clipboard and pretending to understand infrastructure.
 */

const pagePath = path.join(process.cwd(), "app/page.tsx");
const backupPath = path.join(
  process.cwd(),
  `app/page.backup-before-publish-dropdown-timeline-${Date.now()}.tsx`
);
        ...
        >
          ...
          >
            {deploymentTimeline.map((item, index) => {
              ...
              const isFuture = index > deploymentStageIndex;
...
console.log("");
console.log("✅ Added deployment timeline to PublishDropdownPopover.");
