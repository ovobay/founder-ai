...
/**
 * Adds published-state behaviour to PublishDropdownPopover.
 *
 * The main blue action now changes based on state:
 * - Publish
 * - Update
 * - Republish
 * - Update snapshot
 ...
 * - previous file count snapshot
 *
 * Backend deployment can be wired later. For now this gives the UI the right
 * product behaviour instead of one button called "Update" doing interpretive dance.
 */

const pagePath = path.join(process.cwd(), "app/page.tsx");
const backupPath = path.join(
  process.cwd(),
  `app/page.backup-before-published-state-action-${Date.now()}.tsx`
);
...
console.log("");
console.log("✅ Added published-state action behaviour to PublishDropdownPopover.");
